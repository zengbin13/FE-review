	...
	<view>
		...
		<view class="padding">
			<view class="cu-capsule round flex justify-center">
				...
				<navigator class="cu-tag line-orange" url="../im-chat-room/list" style="font-size: 15px;padding:6rpx 30rpx;">
					聊天室
				</navigator>
		...
		<view class="cu-list menu">
			...
			<view class="cu-item" v-for="(group,index) in listData" :key="index" @click="intoGroup(index)">
				<view class="content">
					...
					<text class="text-grey margin-left">（{{group.groupType=="private_group"?"私有群":"公开群"}})</text>
