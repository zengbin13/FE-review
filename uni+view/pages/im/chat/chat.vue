<template>
	<view>
		<view :class="'chat_title ' + (gotop ? 'main_title_hide' : 'main_title_show')"><text>聊天</text></view>
						...
						<view class="list_box">
							<view class="list_left" :data-username="item.username">
								<view class="list_pic">
									...
									<image
										:src="
											item.chatType == 'groupchat' || item.chatType == 'chatRoom' ? '../../static/images/groupTheme.png' : '../../static/images/theme2x.png'
										"
									></image>
								</view>
								<view class="list_text">
									<text class="list_user">
										{{ item.chatType == 'groupchat' || item.chatType == 'chatRoom' || item.groupName ? item.groupName : item.username }}
									</text>
